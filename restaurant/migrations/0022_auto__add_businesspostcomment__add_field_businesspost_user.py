...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('restaurant_businesspostcomment', (
            ...
            ('business', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.BusinessPost'])),
        ...
        # Adding field 'BusinessPost.user'
        db.add_column('restaurant_businesspost', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['restaurant.UserProfile']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BusinessPost.user'
        db.delete_column('restaurant_businesspost', 'user_id')
    ...
    models = {
        ...
        'restaurant.businesspostcomment': {
            ...
            'business': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['restaurant.BusinessPost']"}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'like': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'notification': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
