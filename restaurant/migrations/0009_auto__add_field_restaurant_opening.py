...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Restaurant.opening'
        db.add_column('restaurant_restaurant', 'opening',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Restaurant.opening'
        db.delete_column('restaurant_restaurant', 'opening')
