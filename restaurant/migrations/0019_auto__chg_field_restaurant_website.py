...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('restaurant_restaurant', 'website', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'Restaurant.website'
        db.alter_column('restaurant_restaurant', 'website', self.gf('django.db.models.fields.CharField')(max_length=8))
