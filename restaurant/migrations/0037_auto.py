...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_unique('restaurant_businesspost_who_like', ['businesspost_id', 'wholike_id'])
    ...
    models = {
        ...
        'restaurant.businesspost': {
            ...
            'wholike': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['restaurant.WhoLike']", 'symmetrical': 'False'})
        },
        'restaurant.category': {
