...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BusinessPost'
        db.create_table('restaurant_businesspost', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('business', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.Restaurant'])),
            ('post_to', self.gf('django.db.models.fields.CharField')(max_length=16)),
        ...
        db.send_create_signal('restaurant', ['BusinessPost'])

        # Deleting field 'Post.post_to'
        db.delete_column('restaurant_post', 'post_to_id')


    def backwards(self, orm):
        # Deleting model 'BusinessPost'
        db.delete_table('restaurant_businesspost')

        # Adding field 'Post.post_to'
        db.add_column('restaurant_post', 'post_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['restaurant.Restaurant'], blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'restaurant.businesspost': {
            ...
            'post_to': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
