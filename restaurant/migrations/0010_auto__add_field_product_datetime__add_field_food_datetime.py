...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.datetime'
        db.add_column('restaurant_product', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Food.datetime'
        db.add_column('restaurant_food', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.datetime'
        db.delete_column('restaurant_product', 'datetime')

        # Deleting field 'Food.datetime'
        db.delete_column('restaurant_food', 'datetime')
