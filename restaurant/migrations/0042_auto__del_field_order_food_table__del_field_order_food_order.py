...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('restaurant_order_foods', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('order', models.ForeignKey(orm['restaurant.order'], null=False)),
            ('order_food', models.ForeignKey(orm['restaurant.order_food'], null=False))
        ))
        db.create_unique('restaurant_order_foods', ['order_id', 'order_food_id'])

        # Deleting field 'Order_food.table'
        db.delete_column('restaurant_order_food', 'table_id')

        # Deleting field 'Order_food.order'
        db.delete_column('restaurant_order_food', 'order_id')


    def backwards(self, orm):
        # Removing M2M table for field foods on 'Order'
        db.delete_table('restaurant_order_foods')
        ...
        # Adding field 'Order_food.order'
        db.add_column('restaurant_order_food', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['restaurant.Order']),
                      keep_default=False)
