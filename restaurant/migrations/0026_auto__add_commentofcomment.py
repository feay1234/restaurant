...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CommentOfComment'
        db.create_table('restaurant_commentofcomment', (
        ...
        db.send_create_signal('restaurant', ['CommentOfComment'])
    ...
    def backwards(self, orm):
        # Deleting model 'CommentOfComment'
        db.delete_table('restaurant_commentofcomment')
