...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order_food.restaurant'
        db.add_column('restaurant_order_food', 'restaurant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['restaurant.Restaurant']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order_food.restaurant'
        db.delete_column('restaurant_order_food', 'restaurant_id')
