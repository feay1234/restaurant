...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BusinessPostComment.business'
        db.delete_column('restaurant_businesspostcomment', 'business_id')

        # Deleting field 'BusinessPost.comment'
        db.delete_column('restaurant_businesspost', 'comment')
        ...
        db.create_unique('restaurant_businesspost_comment', ['businesspost_id', 'businesspostcomment_id'])


    def backwards(self, orm):
        # Adding field 'BusinessPostComment.business'
        db.add_column('restaurant_businesspostcomment', 'business',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['restaurant.BusinessPost']),
                      keep_default=False)

        # Adding field 'BusinessPost.comment'
        db.add_column('restaurant_businesspost', 'comment',
    ...
    models = {
        ...
        'restaurant.businesspost': {
            ...
            'comment': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['restaurant.BusinessPostComment']", 'symmetrical': 'False'}),
