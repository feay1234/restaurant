...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field comment on 'BusinessPostComment'
        db.delete_table('restaurant_businesspostcomment_comment')

        # Deleting field 'Comment.post'
        db.delete_column('restaurant_comment', 'post_id')
    ...
    def backwards(self, orm):
        ...
        # Adding M2M table for field comment on 'BusinessPostComment'
        db.create_table('restaurant_businesspostcomment_comment', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('businesspostcomment', models.ForeignKey(orm['restaurant.businesspostcomment'], null=False)),
            ('commentofcomment', models.ForeignKey(orm['restaurant.commentofcomment'], null=False))
        ))
        db.create_unique('restaurant_businesspostcomment_comment', ['businesspostcomment_id', 'commentofcomment_id'])

        # Adding field 'Comment.post'
        db.add_column('restaurant_comment', 'post',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['restaurant.Post']),
                      keep_default=False)
    ...
    models = {
        ...
        'restaurant.businesspost': {
            ...
            'comment': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['restaurant.Comment']", 'symmetrical': 'False'}),
