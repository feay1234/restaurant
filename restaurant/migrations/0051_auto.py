...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing M2M table for field comments on 'Restaurant'
        db.delete_table('restaurant_restaurant_comments')


    def backwards(self, orm):
        # Adding M2M table for field comments on 'Restaurant'
        db.create_table('restaurant_restaurant_comments', (
        ...
        db.create_unique('restaurant_restaurant_comments', ['restaurant_id', 'comment_id'])
