...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field follower on 'Restaurant'
        db.create_table('restaurant_restaurant_follower', (
        ...
        db.create_unique('restaurant_restaurant_follower', ['restaurant_id', 'userprofile_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field follower on 'Restaurant'
        db.delete_table('restaurant_restaurant_follower')
