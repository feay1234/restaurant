...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.likes'
        db.delete_column('restaurant_product', 'likes')

        # Adding field 'Product.like'
        db.add_column('restaurant_product', 'like',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Shop.likes'
        db.delete_column('restaurant_shop', 'likes')

        # Adding field 'Shop.like'
        db.add_column('restaurant_shop', 'like',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Category.likes'
        db.delete_column('restaurant_category', 'likes')

        # Adding field 'Category.like'
        db.add_column('restaurant_category', 'like',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Post.likes'
        db.delete_column('restaurant_post', 'likes')

        # Adding field 'Post.like'
        db.add_column('restaurant_post', 'like',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'BusinessPost.likes'
        db.delete_column('restaurant_businesspost', 'likes')

        # Adding field 'BusinessPost.like'
        db.add_column('restaurant_businesspost', 'like',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Comment.likes'
        db.delete_column('restaurant_comment', 'likes')

        # Adding field 'Comment.like'
        db.add_column('restaurant_comment', 'like',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Drink.likes'
        db.delete_column('restaurant_drink', 'likes')

        # Adding field 'Drink.like'
        db.add_column('restaurant_drink', 'like',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Food.likes'
        db.delete_column('restaurant_food', 'likes')

        # Adding field 'Food.like'
        db.add_column('restaurant_food', 'like',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Product.likes'
        db.add_column('restaurant_product', 'likes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Product.like'
        db.delete_column('restaurant_product', 'like')

        # Adding field 'Shop.likes'
        db.add_column('restaurant_shop', 'likes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Shop.like'
        db.delete_column('restaurant_shop', 'like')

        # Adding field 'Category.likes'
        db.add_column('restaurant_category', 'likes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Category.like'
        db.delete_column('restaurant_category', 'like')

        # Adding field 'Post.likes'
        db.add_column('restaurant_post', 'likes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Post.like'
        db.delete_column('restaurant_post', 'like')

        # Adding field 'BusinessPost.likes'
        db.add_column('restaurant_businesspost', 'likes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'BusinessPost.like'
        db.delete_column('restaurant_businesspost', 'like')

        # Adding field 'Comment.likes'
        db.add_column('restaurant_comment', 'likes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Comment.like'
        db.delete_column('restaurant_comment', 'like')

        # Adding field 'Drink.likes'
        db.add_column('restaurant_drink', 'likes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Drink.like'
        db.delete_column('restaurant_drink', 'like')

        # Adding field 'Food.likes'
        db.add_column('restaurant_food', 'likes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Food.like'
        db.delete_column('restaurant_food', 'like')
