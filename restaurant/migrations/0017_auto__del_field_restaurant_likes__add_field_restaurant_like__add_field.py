...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Restaurant.likes'
        db.delete_column('restaurant_restaurant', 'likes')

        # Adding field 'Restaurant.like'
        db.add_column('restaurant_restaurant', 'like',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Restaurant.visiting'
        db.add_column('restaurant_restaurant', 'visiting',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Restaurant.visitor'
        db.add_column('restaurant_restaurant', 'visitor',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Restaurant.follow'
        db.add_column('restaurant_restaurant', 'follow',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Restaurant.description'
        db.alter_column('restaurant_restaurant', 'description', self.gf('django.db.models.fields.CharField')(max_length=16))

    def backwards(self, orm):
        # Adding field 'Restaurant.likes'
        db.add_column('restaurant_restaurant', 'likes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Restaurant.like'
        db.delete_column('restaurant_restaurant', 'like')

        # Deleting field 'Restaurant.visiting'
        db.delete_column('restaurant_restaurant', 'visiting')

        # Deleting field 'Restaurant.visitor'
        db.delete_column('restaurant_restaurant', 'visitor')

        # Deleting field 'Restaurant.follow'
        db.delete_column('restaurant_restaurant', 'follow')


        # Changing field 'Restaurant.description'
        db.alter_column('restaurant_restaurant', 'description', self.gf('django.db.models.fields.CharField')(max_length=128))
    ...
    models = {
        ...
        'restaurant.restaurant': {
            ...
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
