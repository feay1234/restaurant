...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('restaurant_comment_comments', (
        ...
        db.create_unique('restaurant_comment_comments', ['comment_id', 'commentofcomment_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('restaurant_comment_comments')
