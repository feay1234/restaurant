...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('restaurant_foodreview', (
        ...
        db.send_create_signal('restaurant', ['FoodReview'])

        # Adding M2M table for field who_like on 'FoodReview'
        db.create_table('restaurant_foodreview_who_like', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('foodreview', models.ForeignKey(orm['restaurant.foodreview'], null=False)),
            ('userprofile', models.ForeignKey(orm['restaurant.userprofile'], null=False))
        ))
        db.create_unique('restaurant_foodreview_who_like', ['foodreview_id', 'userprofile_id'])

        # Removing M2M table for field comments on 'Food'
        db.delete_table('restaurant_food_comments')


    def backwards(self, orm):
        # Deleting model 'FoodReview'
        db.delete_table('restaurant_foodreview')

        # Removing M2M table for field who_like on 'FoodReview'
        db.delete_table('restaurant_foodreview_who_like')

        # Adding M2M table for field comments on 'Food'
        db.create_table('restaurant_food_comments', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('food', models.ForeignKey(orm['restaurant.food'], null=False)),
            ('comment', models.ForeignKey(orm['restaurant.comment'], null=False))
        ))
        db.create_unique('restaurant_food_comments', ['food_id', 'comment_id'])
