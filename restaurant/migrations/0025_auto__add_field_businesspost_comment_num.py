...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessPost.comment_num'
        db.add_column('restaurant_businesspost', 'comment_num',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessPost.comment_num'
        db.delete_column('restaurant_businesspost', 'comment_num')
