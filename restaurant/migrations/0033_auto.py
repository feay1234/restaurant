...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_unique('restaurant_businesspost_comment', ['businesspost_id', 'comment_id'])
    ...
    models = {
        ...
        'restaurant.businesspost': {
            ...
            'comment2': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['restaurant.Comment']", 'symmetrical': 'False'}),
