...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BusinessPost.post_to'
        db.delete_column('restaurant_businesspost', 'post_to')


    def backwards(self, orm):
        # Adding field 'BusinessPost.post_to'
        db.add_column('restaurant_businesspost', 'post_to',
