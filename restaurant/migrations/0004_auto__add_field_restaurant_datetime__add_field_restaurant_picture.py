...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Restaurant.datetime'
        db.add_column('restaurant_restaurant', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Restaurant.picture'
        db.add_column('restaurant_restaurant', 'picture',
                      self.gf('django.db.models.fields.files.ImageField')(default=0, max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Restaurant.datetime'
        db.delete_column('restaurant_restaurant', 'datetime')

        # Deleting field 'Restaurant.picture'
        db.delete_column('restaurant_restaurant', 'picture')
