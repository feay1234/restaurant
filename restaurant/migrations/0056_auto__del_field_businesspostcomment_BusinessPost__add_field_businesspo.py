...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BusinessPostComment.BusinessPost'
        db.delete_column('restaurant_businesspostcomment', 'BusinessPost_id')

        # Adding field 'BusinessPostComment.post'
        db.add_column('restaurant_businesspostcomment', 'post',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['restaurant.BusinessPost']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BusinessPostComment.BusinessPost'
        db.add_column('restaurant_businesspostcomment', 'BusinessPost',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['restaurant.BusinessPost']),
                      keep_default=False)

        # Deleting field 'BusinessPostComment.post'
        db.delete_column('restaurant_businesspostcomment', 'post_id')
    ...
    models = {
        ...
        'restaurant.businesspostcomment': {
            ...
            'like': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'notification': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['restaurant.BusinessPost']"}),
            'text': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['restaurant.UserProfile']"}),
