...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'RestaurantReviewComment'
        db.delete_table('restaurant_restaurantreviewcomment')

        # Removing M2M table for field who_like on 'RestaurantReviewComment'
        db.delete_table('restaurant_restaurantreviewcomment_who_like')

        # Adding model 'BusinessPostComment'
        db.create_table('restaurant_businesspostcomment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.UserProfile'])),
            ('BusinessPost', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.BusinessPost'])),
        ...
        db.send_create_signal('restaurant', ['BusinessPostComment'])

        # Adding M2M table for field who_like on 'BusinessPostComment'
        db.create_table('restaurant_businesspostcomment_who_like', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('businesspostcomment', models.ForeignKey(orm['restaurant.businesspostcomment'], null=False)),
            ('userprofile', models.ForeignKey(orm['restaurant.userprofile'], null=False))
        ))
        db.create_unique('restaurant_businesspostcomment_who_like', ['businesspostcomment_id', 'userprofile_id'])

        # Removing M2M table for field comments on 'BusinessPost'
        db.delete_table('restaurant_businesspost_comments')


    def backwards(self, orm):
        # Adding model 'RestaurantReviewComment'
        db.create_table('restaurant_restaurantreviewcomment', (
            ('restaurantReview', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.RestaurantReview'])),
            ('like', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('notification', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.UserProfile'])),
        ...
        db.send_create_signal('restaurant', ['RestaurantReviewComment'])

        # Adding M2M table for field who_like on 'RestaurantReviewComment'
        db.create_table('restaurant_restaurantreviewcomment_who_like', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('restaurantreviewcomment', models.ForeignKey(orm['restaurant.restaurantreviewcomment'], null=False)),
            ('userprofile', models.ForeignKey(orm['restaurant.userprofile'], null=False))
        ))
        db.create_unique('restaurant_restaurantreviewcomment_who_like', ['restaurantreviewcomment_id', 'userprofile_id'])

        # Deleting model 'BusinessPostComment'
        db.delete_table('restaurant_businesspostcomment')

        # Removing M2M table for field who_like on 'BusinessPostComment'
        db.delete_table('restaurant_businesspostcomment_who_like')

        # Adding M2M table for field comments on 'BusinessPost'
        db.create_table('restaurant_businesspost_comments', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
        ...
        db.create_unique('restaurant_businesspost_comments', ['businesspost_id', 'comment_id'])
    ...
    models = {
        ...
        'restaurant.businesspostcomment': {
            'BusinessPost': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['restaurant.BusinessPost']"}),
            'Meta': {'object_name': 'BusinessPostComment'},
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'like': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'notification': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'text': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['restaurant.UserProfile']"}),
            'who_like': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'rrc_who_like'", 'symmetrical': 'False', 'to': "orm['restaurant.UserProfile']"})
        },
        'restaurant.category': {
        ...
        'restaurant.foodreview': {
            'Meta': {'object_name': 'FoodReview'},
            'comment_num': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'datetime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'food': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['restaurant.Food']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['restaurant.UserProfile']"}),
            'who_like': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'fr_who_like'", 'symmetrical': 'False', 'to': "orm['restaurant.UserProfile']"})
        },
        ...
        'restaurant.restaurant': {
            ...
            'follower': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'follower'", 'symmetrical': 'False', 'to': "orm['restaurant.UserProfile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'restaurant.restaurantreview': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['restaurant.UserProfile']"}),
            'who_like': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'rr_who_like'", 'symmetrical': 'False', 'to': "orm['restaurant.UserProfile']"})
        },
        'restaurant.shop': {
