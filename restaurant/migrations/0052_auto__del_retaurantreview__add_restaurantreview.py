...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'RetaurantReview'
        db.delete_table('restaurant_retaurantreview')

        # Removing M2M table for field who_like on 'RetaurantReview'
        db.delete_table('restaurant_retaurantreview_who_like')

        # Adding model 'RestaurantReview'
        db.create_table('restaurant_restaurantreview', (
            ...
            ('comment_num', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('notification', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('restaurant', ['RestaurantReview'])

        # Adding M2M table for field who_like on 'RestaurantReview'
        db.create_table('restaurant_restaurantreview_who_like', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('restaurantreview', models.ForeignKey(orm['restaurant.restaurantreview'], null=False)),
            ('userprofile', models.ForeignKey(orm['restaurant.userprofile'], null=False))
        ))
        db.create_unique('restaurant_restaurantreview_who_like', ['restaurantreview_id', 'userprofile_id'])


    def backwards(self, orm):
        # Adding model 'RetaurantReview'
        db.create_table('restaurant_retaurantreview', (
            ('picture', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.UserProfile'])),
        ...
        db.send_create_signal('restaurant', ['RetaurantReview'])

        # Adding M2M table for field who_like on 'RetaurantReview'
        db.create_table('restaurant_retaurantreview_who_like', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('retaurantreview', models.ForeignKey(orm['restaurant.retaurantreview'], null=False)),
            ('userprofile', models.ForeignKey(orm['restaurant.userprofile'], null=False))
        ))
        db.create_unique('restaurant_retaurantreview_who_like', ['retaurantreview_id', 'userprofile_id'])

        # Deleting model 'RestaurantReview'
        db.delete_table('restaurant_restaurantreview')

        # Removing M2M table for field who_like on 'RestaurantReview'
        db.delete_table('restaurant_restaurantreview_who_like')
