...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Shop.description'
        db.add_column('restaurant_shop', 'description',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=128),
                      keep_default=False)

        # Adding field 'Restaurant.description'
        db.add_column('restaurant_restaurant', 'description',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Shop.description'
        db.delete_column('restaurant_shop', 'description')

        # Deleting field 'Restaurant.description'
        db.delete_column('restaurant_restaurant', 'description')
