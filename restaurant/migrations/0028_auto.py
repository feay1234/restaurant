...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field who_like on 'CommentOfComment'
        db.create_table('restaurant_commentofcomment_who_like', (
        ...
        db.create_unique('restaurant_commentofcomment_who_like', ['commentofcomment_id', 'userprofile_id'])
    ...
    def backwards(self, orm):
        # Removing M2M table for field who_like on 'CommentOfComment'
        db.delete_table('restaurant_commentofcomment_who_like')
