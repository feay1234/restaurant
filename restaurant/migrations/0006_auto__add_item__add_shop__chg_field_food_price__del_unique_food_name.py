...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique('restaurant_food', ['name'])

        # Adding model 'Item'
        db.create_table('restaurant_item', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shop', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.Shop'])),
        ...
        db.send_create_signal('restaurant', ['Item'])

        # Adding model 'Shop'
        db.create_table('restaurant_shop', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('restaurant', ['Shop'])


        # Changing field 'Food.price'
        db.alter_column('restaurant_food', 'price', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):
        # Deleting model 'Item'
        db.delete_table('restaurant_item')

        # Deleting model 'Shop'
        db.delete_table('restaurant_shop')


        # Changing field 'Food.price'
        db.alter_column('restaurant_food', 'price', self.gf('django.db.models.fields.PositiveIntegerField')())
        # Adding unique constraint on 'Food', fields ['name']
        db.create_unique('restaurant_food', ['name'])
