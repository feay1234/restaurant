...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BusinessPost.share'
        db.add_column('restaurant_businesspost', 'share',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BusinessPost.share'
        db.delete_column('restaurant_businesspost', 'share')
    ...
    models = {
        ...
        'restaurant.businesspost': {
            ...
            'comment': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
