...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Restaurant.website'
        db.add_column('restaurant_restaurant', 'website',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=8, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Restaurant.website'
        db.delete_column('restaurant_restaurant', 'website')
    ...
    models = {
        ...
        'restaurant.restaurant': {
            ...
            'website': ('django.db.models.fields.CharField', [], {'max_length': '8', 'blank': 'True'}),
