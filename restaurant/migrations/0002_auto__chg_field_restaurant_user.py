...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('restaurant_restaurant', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.UserProfile']))

    def backwards(self, orm):

        # Changing field 'Restaurant.user'
        db.alter_column('restaurant_restaurant', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
