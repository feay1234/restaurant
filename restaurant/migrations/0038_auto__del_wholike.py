...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'WhoLike'
        db.delete_table('restaurant_wholike')

        # Removing M2M table for field wholike on 'BusinessPost'
        db.delete_table('restaurant_businesspost_wholike')

        # Adding M2M table for field who_like on 'BusinessPost'
        db.create_table('restaurant_businesspost_who_like', (
        ...
        db.create_unique('restaurant_businesspost_who_like', ['businesspost_id', 'userprofile_id'])


    def backwards(self, orm):
        # Adding model 'WhoLike'
        db.create_table('restaurant_wholike', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['restaurant.UserProfile'])),
        ))
        db.send_create_signal('restaurant', ['WhoLike'])

        # Adding M2M table for field wholike on 'BusinessPost'
        db.create_table('restaurant_businesspost_wholike', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('businesspost', models.ForeignKey(orm['restaurant.businesspost'], null=False)),
            ('wholike', models.ForeignKey(orm['restaurant.wholike'], null=False))
        ))
        db.create_unique('restaurant_businesspost_wholike', ['businesspost_id', 'wholike_id'])

        # Removing M2M table for field who_like on 'BusinessPost'
        db.delete_table('restaurant_businesspost_who_like')
